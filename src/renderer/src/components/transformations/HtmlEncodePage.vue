...
const transformationName = 'Html Encode'
const transformationDescription = 'Encode special characters for HTML'
const inputPlaceholder = 'Enter text to HTML encode...'
const outputPlaceholder = 'HTML encoded text will appear here...'
const transformButtonText = 'Encode'
...
const applyTransformation = async (): Promise<void> => {
  ...
  try {
    // Apply the transformation
    outputText.value = await htmlEncode(inputText.value)
