...
const transformationName = 'Url Encode'
const transformationDescription = 'Encode text for use in URLs'
const inputPlaceholder = 'Enter text to URL encode...'
...
const applyTransformation = async (): Promise<void> => {
  ...
  try {
    // Apply the transformation
    outputText.value = await urlEncode(inputText.value)
