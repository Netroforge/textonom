...
const transformationName = 'Xml Compact'
const transformationDescription = 'Compact XML by removing whitespace'
const inputPlaceholder = 'Enter XML to compact...'
const outputPlaceholder = 'Compacted XML will appear here...'
...
const applyTransformation = async (): Promise<void> => {
  ...
  try {
    // Apply the transformation
    outputText.value = await xmlCompact(inputText.value)
