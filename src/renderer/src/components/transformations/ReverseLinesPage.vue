...
const transformationName = 'Reverse Lines'
const transformationDescription = 'Reverse the order of lines'
const inputPlaceholder = 'Enter text with multiple lines to reverse...'
const outputPlaceholder = 'Reversed lines will appear here...'
const transformButtonText = 'Reverse'
...
const applyTransformation = async (): Promise<void> => {
  ...
  try {
    // Apply the transformation
    outputText.value = await reverseLines(inputText.value)
