...
const transformationName = 'To Uppercase'
const transformationDescription = 'Convert text to uppercase'
const inputPlaceholder = 'Enter text to convert to uppercase...'
const outputPlaceholder = 'Uppercase text will appear here...'
...
const applyTransformation = async (): Promise<void> => {
  ...
  try {
    // Apply the transformation
    outputText.value = await toUpperCase(inputText.value)
