...
const transformationName = 'Json Prettify'
const transformationDescription = 'Format JSON with proper indentation'
const inputPlaceholder = 'Enter JSON to prettify...'
const outputPlaceholder = 'Prettified JSON will appear here...'
const transformButtonText = 'Prettify'
...
const applyTransformation = async (): Promise<void> => {
  ...
  try {
    // Apply the transformation
    outputText.value = await jsonPrettify(inputText.value)
