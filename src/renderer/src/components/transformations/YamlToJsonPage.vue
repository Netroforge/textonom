...
const transformationName = 'Yaml To Json'
const transformationDescription = 'Convert YAML to JSON format'
const inputPlaceholder = 'Enter YAML to convert to JSON...'
const outputPlaceholder = 'JSON output will appear here...'
...
const applyTransformation = async (): Promise<void> => {
  ...
  try {
    // Apply the transformation
    outputText.value = await yamlToJson(inputText.value)
