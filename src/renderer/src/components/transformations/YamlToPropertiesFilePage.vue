...
const transformationName = 'Yaml To Properties File'
const transformationDescription = 'Convert YAML to Java properties file format'
const inputPlaceholder = 'Enter YAML to convert to properties file format...'
const outputPlaceholder = 'Properties file output will appear here...'
const transformButtonText = 'Convert'
...
const applyTransformation = async (): Promise<void> => {
  ...
  try {
    // Apply the transformation
    outputText.value = await yamlToPropertiesFile(inputText.value)
