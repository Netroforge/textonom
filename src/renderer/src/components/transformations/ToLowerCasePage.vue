...
const transformationName = 'To Lower Case'
const transformationDescription = 'Convert text to lowercase'
const inputPlaceholder = 'Enter text to convert to lowercase...'
const outputPlaceholder = 'Lowercase text will appear here...'
...
const applyTransformation = async (): Promise<void> => {
  ...
  try {
    // Apply the transformation
    outputText.value = await toLowerCase(inputText.value)
