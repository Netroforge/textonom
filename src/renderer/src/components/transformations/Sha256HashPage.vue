...
const transformationName = 'Sha256 Hash'
const transformationDescription = 'Generate SHA-256 hash of text'
const inputPlaceholder = 'Enter text to hash...'
const outputPlaceholder = 'SHA-256 hash will appear here...'
...
const applyTransformation = async (): Promise<void> => {
  ...
  try {
    // Apply the transformation
    outputText.value = await sha256Hash(inputText.value)
