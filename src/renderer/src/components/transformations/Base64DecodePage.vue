...
const transformationName = 'Base64 Decode'
const transformationDescription = 'Decode Base64 encoded text'
const inputPlaceholder = 'Enter Base64 text to decode...'
const outputPlaceholder = 'Decoded output will appear here...'
...
const applyTransformation = async (): Promise<void> => {
  ...
  try {
    // Apply the transformation
    outputText.value = await base64Decode(inputText.value)
