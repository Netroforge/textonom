...
const transformationName = 'Md5 Hash'
const transformationDescription = 'Generate MD5 hash of text'
const inputPlaceholder = 'Enter text to hash...'
const outputPlaceholder = 'MD5 hash will appear here...'
...
const applyTransformation = async (): Promise<void> => {
  ...
  try {
    // Apply the transformation
    outputText.value = await md5Hash(inputText.value)
