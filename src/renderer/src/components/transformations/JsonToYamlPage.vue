...
const transformationName = 'Json To Yaml'
const transformationDescription = 'Convert JSON to YAML format'
const inputPlaceholder = 'Enter JSON to convert to YAML...'
...
const applyTransformation = async (): Promise<void> => {
  ...
  try {
    // Apply the transformation
    outputText.value = await jsonToYaml(inputText.value)
