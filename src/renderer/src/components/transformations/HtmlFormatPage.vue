...
const applyTransformation = async (): Promise<void> => {
  ...
  try {
    const result = await htmlFormat(inputText.value, { indentSize: indentSize.value })
...
<template>
  <div class="transformation-page">
    <div class="transformation-header">
      ...
      <p class="transformation-description">Format HTML code with proper indentation</p>
    </div>
    ...
    <div class="transformation-content">
      ...
      <div class="textarea-container">
        ...
        <div class="textarea-wrapper">
          <TransformationAnimation v-if="isTransforming" transformation-name="HTML Format" />
          <textarea
            id="output-textarea"
            :value="outputText"
            readonly
