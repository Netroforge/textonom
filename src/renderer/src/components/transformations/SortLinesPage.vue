...
const transformationName = 'Sort Lines'
const transformationDescription = 'Sort lines alphabetically'
const inputPlaceholder = 'Enter text with multiple lines to sort...'
const outputPlaceholder = 'Sorted lines will appear here...'
const transformButtonText = 'Sort'
...
const applyTransformation = async (): Promise<void> => {
  ...
  try {
    // Apply the transformation
    outputText.value = await sortLines(inputText.value)
