...
const transformationName = 'Xml Prettify'
const transformationDescription = 'Format XML with proper indentation'
const inputPlaceholder = 'Enter XML to prettify...'
const outputPlaceholder = 'Prettified XML will appear here...'
...
const applyTransformation = async (): Promise<void> => {
  ...
  try {
    // Apply the transformation
    outputText.value = await xmlPrettify(inputText.value)
