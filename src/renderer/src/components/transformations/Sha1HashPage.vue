...
const transformationName = 'Sha1 Hash'
const transformationDescription = 'Generate SHA-1 hash of text'
const inputPlaceholder = 'Enter text to hash...'
const outputPlaceholder = 'SHA-1 hash will appear here...'
...
const applyTransformation = async (): Promise<void> => {
  ...
  try {
    // Apply the transformation
    outputText.value = await sha1Hash(inputText.value)
