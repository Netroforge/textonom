...
const applyTransformation = async (): Promise<void> => {
  ...
  try {
    const result = await cssFormat(inputText.value, { indentSize: indentSize.value })
...
<template>
  <div class="transformation-page">
    <div class="transformation-header">
      <h1>CSS Formatter</h1>
      <p class="transformation-description">Format CSS code with proper indentation</p>
    </div>
    ...
    <div class="transformation-content">
      ...
      <div class="textarea-container">
        ...
        <div class="textarea-wrapper">
          <TransformationAnimation v-if="isTransforming" transformation-name="CSS Format" />
          <textarea
            id="output-textarea"
            :value="outputText"
            readonly
