...
const transformationName = 'To Title Case'
const transformationDescription =
  'Convert text to title case (first letter of each word capitalized)'
const inputPlaceholder = 'Enter text to convert to title case...'
const outputPlaceholder = 'Title case text will appear here...'
...
const applyTransformation = async (): Promise<void> => {
  ...
  try {
    // Apply the transformation
    outputText.value = await toTitleCase(inputText.value)
