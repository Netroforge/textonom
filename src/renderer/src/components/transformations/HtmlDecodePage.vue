...
const transformationName = 'Html Decode'
const transformationDescription = 'Decode HTML entities to characters'
const inputPlaceholder = 'Enter HTML encoded text to decode...'
const outputPlaceholder = 'HTML decoded text will appear here...'
...
const applyTransformation = async (): Promise<void> => {
  ...
  try {
    // Apply the transformation
    outputText.value = await htmlDecode(inputText.value)
