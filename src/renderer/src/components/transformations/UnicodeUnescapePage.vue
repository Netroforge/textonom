...
const transformationName = 'Unicode Unescape'
const transformationDescription = 'Convert \\uXXXX format to actual Unicode characters'
const inputPlaceholder = 'Enter Unicode escaped text to unescape...'
const outputPlaceholder = 'Unicode unescaped text will appear here...'
const transformButtonText = 'Unescape'
...
const applyTransformation = async (): Promise<void> => {
  ...
  try {
    // Apply the transformation
    outputText.value = await unicodeUnescape(inputText.value)
