...
const transformationName = 'Deduplicate Lines'
const transformationDescription = 'Remove duplicate lines'
const inputPlaceholder = 'Enter text with duplicate lines to remove...'
const outputPlaceholder = 'Deduplicated lines will appear here...'
const transformButtonText = 'Deduplicate'
...
const applyTransformation = async (): Promise<void> => {
  ...
  try {
    // Apply the transformation
    outputText.value = await deduplicateLines(inputText.value)
