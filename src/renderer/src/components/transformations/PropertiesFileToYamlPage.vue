...
const transformationName = 'Properties File To Yaml'
const transformationDescription = 'Convert Java properties file to YAML'
const inputPlaceholder = 'Enter properties file content to convert to YAML...'
const outputPlaceholder = 'YAML output will appear here...'
...
const applyTransformation = async (): Promise<void> => {
  ...
  try {
    // Apply the transformation
    outputText.value = await propertiesFileToYaml(inputText.value)
