...
const transformationName = 'Base64 Encode'
const transformationDescription = 'Encode text to Base64 format'
const inputPlaceholder = 'Enter text to encode...'
const outputPlaceholder = 'Encoded output will appear here...'
...
const applyTransformation = async (): Promise<void> => {
  ...
  try {
    // Apply the transformation
    outputText.value = await base64Encode(inputText.value)
