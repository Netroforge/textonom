...
const transformationName = 'Json Compact'
const transformationDescription = 'Compact JSON by removing whitespace'
const inputPlaceholder = 'Enter JSON to compact...'
const outputPlaceholder = 'Compacted JSON will appear here...'
const transformButtonText = 'Compact'
...
const applyTransformation = async (): Promise<void> => {
  ...
  try {
    // Apply the transformation
    outputText.value = await jsonCompact(inputText.value)
