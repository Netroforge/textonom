...
const transformationName = 'Unicode Escape'
const transformationDescription = 'Escape Unicode characters to \\uXXXX format'
const inputPlaceholder = 'Enter text with Unicode characters to escape...'
const outputPlaceholder = 'Unicode escaped text will appear here...'
const transformButtonText = 'Escape'
...
const applyTransformation = async (): Promise<void> => {
  ...
  try {
    // Apply the transformation
    outputText.value = await unicodeEscape(inputText.value)
